...
class dataODB:
    def __init__(self,prompt="Select !!input!! database file",DefaultDirec="H:\\QuotaCalcs\\data", FileExt="Access Files (*.mdb *.accdb)"):
...
class resultODB:
    def __init__(self,prompt="Select **output** database file",DefaultDirec="H:\\QuotaCalcs\\data", FileExt="Access Files (*.mdb *.accdb)"):
